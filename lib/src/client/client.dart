...
abstract class Client extends ClientBase {
  core.String basePath = "/plusDomains/v1/";
  ...
  AudiencesResource_ get audiences => new AudiencesResource_(this);
  CirclesResource_ get circles => new CirclesResource_(this);
  CommentsResource_ get comments => new CommentsResource_(this);
  MediaResource_ get media => new MediaResource_(this);
  PeopleResource_ get people => new PeopleResource_(this);
